            ...
            <div className={styles.about_container}>
                ...
                <Container className={styles.about_text_container}>
                    ...
                    <Container className={styles.about_text}>
                        ...
                        Spacemakers is a project started in a local youth house, Jeugdhuis Krak, in a small town called Avelgem, Belgium. The project purely grew on a voluntary basis with all members developing their own expertise in their field of interest. This created a group of young, motivated creators with a skill set ranging from projection mapping, animation, stage design to software development, electronics, generative art and so much more.                    </Container>
                </Container>
            </div>
        </div>
    );
